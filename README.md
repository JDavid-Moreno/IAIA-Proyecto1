...
| `main.py` *(ajusta el nombre si lo tienes guardado distinto)* | Implementación de la búsqueda: clases `Node`, `Frontier`, `Problem`, funciones `expand`, `best_first_search`, `path_actions`, `show_result`. Aquí vive la lógica de A* aplicada al problema.                                                                                                                                                                                                               |
